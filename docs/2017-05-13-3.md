...
经过前面漫长的铺垫，我们的终极武器就呼之欲出了。现在，我们将组织地海空三位一体的立体打击火力，击破长难句的袭扰。简而言之，**逻辑语义是进攻的重器，句法则是坚强的保障后盾**。
...
下面是两例典型的以修饰性成分为主的长句，重点关注其中的主从句关系，把握主从句结构的架构特点。
...
在这一章的讲解中，我们把句法和词法完全分割开，以期达到的效果就是：不必掌握每一个词也能理清句群的走向。

最后简单地回顾一下重要的概念：

1. 规定一句话中只能有一个动词。

2. 为了突破(1)的限制，我们发明了复合句。

3. 主从结构是复句的精华所在；并列结构是逻辑脉络的支柱。

4. 主从结构中的指代关系构成了修饰关系的全部生命力。
